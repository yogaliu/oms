...
angular.module('klwkOmsApp')
    .directive('advancedSearchList', function () {
        return {
            ...
            template : '<div class="searchItem" ng-hide="!!configData.chosed[configData.filed]">'+
    ...
    .directive('advancedSearchMoreList', function () {
        return {
            ...
            template : '<div class="searchItem" ng-hide="!!searchConfig.chosed[searchConfig.filed] || searchConfig.moreChose || searchConfig.isShow">' +
    ...
    .directive('advanceSearchMoreListShow', function () {
        return {
            ...
            template : '<div class="searchItem spread" ng-show="(searchConfig.moreShow == searchConfig.filed)">' +
                        '<span class="title">{{searchConfig.title}}</span>'+
            '<div class="options">' +
