...
angular.module("klwkOmsApp")
    .factory('addLoanService', ["ApiService","APP_COLORS","WAP_CONFIG","APP_MENU","APP_DATA","toolsService",function(ApiService,APP_COLORS,WAP_CONFIG,APP_MENU,APP_DATA,toolsService){
        var configParam = {
         ...
         * 保存新增借调单
         */
        var loanSave = function (scope){
            var url = "/Inventory/LoanOut/Save";
            var paramObj = configParam.getParamObj();
            var data=[];
                ...
                data.push(
                    {
                        ...
                        "LoanOutId":obj.loanuutid?obj.loanuutid:0,   //借出单据ID
                        "SkuId":obj.skuid,
                        "PlanQuantity":obj.planquantity?obj.planquantity:1,   //计划数量
                        "OutQuantity":0,   //实际出库数量
                        "ReturnQuantity":0, //已归还数量
                        "UnReturnQuantity":0,   //未归还数量
                        "LockQuantity":0,  //锁定数量
                        "Sku":{
                            "SkuId" : obj.sku.skuid,
                            ...
                            "Quantity" : obj.sku.quantity?obj.sku.quantity:0,
            ...
            promise.then(function(res){
                if(res.success){
                    ...
                    scope.addTab('借出单','../template/inventoryManage/lendList.html');
                }
            });
        };
