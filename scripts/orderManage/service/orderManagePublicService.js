    ...
    .service('orderManagePublicService',['ApiService','toolsService',
        function (ApiService, toolsService) {
            ...
            var orderManagerPublicFunction = {
                 ...
                 * @param dataType 字段类型
                 * @param listNum 默认显示几条数据
                 */
                setDataShowType : function (scope,data,dataType,listNum) {
                    var characterFirst;
                ...
                checkOrderListValidity : function (scope,obj,label) {
                    ...
                    for(var i = 0,j = obj.length;i < j;i++){
                        ...
                        //是不是自己锁定的订单
                        label['isSelfLocked'] = (label['isSelfLocked']) || (obj[i].lockedusername != ApiService.getBasicParamobj.UserName);
                        //已全部配货
