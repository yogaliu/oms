...
angular.module("klwkOmsApp")
    .service("fbpQuitGoodsNoticeBillDetailService", ["ApiService", function (ApiService) {
        var configData = {
            columns: [
        ...
        var Interface = {
            getPlanList: function (scope, callback) {
                var url = '/B2B/B2BReturnOrderNoticeDetail/Get';
                ...
                paramObj['body'] = JSON.stringify(
                    [{
                        ...
                        "Value": scope.returnordernoticeid,
                        "Children": []
                    }]
                );
            ...
            getLogList: function (scope, callback) {
                var url = '/B2B/B2BReturnOrderNoticeLog/Get';
                var paramObj = ApiService.getBasicParamobj();
                paramObj['body'] = JSON.stringify(
                    [{
                        "OperateType": 0,
